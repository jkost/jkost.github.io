# 1.3 Προγραμματισμός με πλακίδια {#Intro} 
© Γιάννης Κωστάρας
...
* να γράφουμε τα πρώτα μας προγράμματα
* τα δομικά μπλοκ μιας γλώσσας προγραμματισμού
...
2. Η [Ψευδογλώσσα](https://www.pseudoglossa.com/) είναι η μόνη ελληνική εφαρμογή για Android που περιλαμβάνει έναν αυτοσχέδιο διερμηνευτή της Ψευδογλώσσας και της ΓΛΩΣΣΑΣ, για ανάπτυξη και εκτέλεση προγραμμάτων, απευθείας στη συσκευή σας.
