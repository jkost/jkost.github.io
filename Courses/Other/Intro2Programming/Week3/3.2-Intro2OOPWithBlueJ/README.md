...
[🏠](https://jkost.github.io) | [⬆️](../../README.md) | [◀️](../3.1-Intro2OOP/README.md) | [▶️](../3.3-Static/README.md)
...
5. Σβήστε τα κίτρινα μπλοκ κώδικα που έχει δημιουργήσει το BlueJ. Ο κώδικας σας θα πρέπει να μοιάζει με τον παρακάτω:
