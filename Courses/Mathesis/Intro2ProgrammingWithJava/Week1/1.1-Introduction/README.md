...
_Στο μάθημα 1.4 θα μάθουμε πώς να εγκαταστήσουμε το Jupyter Lab ώστε να μπορούμε να ανοίγουμε αρχεία ```.ipynb```. Εναλλακτικά μπορείτε να χρησιμοποιήσετε το [Visual Studio Code](https://code.visualstudio.com/download), ή να τα ανοίξετε στο [Colab](https://colab.research.google.com/) επιλέγοντας **Upload**. Δυστυχώς, το Colab δεν υποστηρίζει Java αλλά θα μπορέσετε να διαβάσετε το αρχείο._
