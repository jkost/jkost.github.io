...
* Ενω overloading υποστηρίζεται και από μεθόδους κατασκευής και από στατικές και μη στατικές μεθόδους τόσο στην ίδια κλάση όσο και στις υποκλάσεις της, η επικάλυψη μεθόδων (overriding) υποστηρίζεται μόνο από τις υποκλάσεις και μόνο για τις μη στατικές (instance) μεθόδους
