...
Να δηλώσουμε εδώ ότι τα άγκιστρα ```{ }``` δηλώνουν ένα μπλοκ κώδικα στη Java, π.χ.
...
Τα άγκιστρα μπορούν να παραληφθούν μετά τη συνθήκη στην εντολή ```if``` αν ακολουθεί μία μόνο εντολή, δηλ.
...
3. [Υπολογίστε αν ένα έτος είναι δίσεκτο. Ένα έτος είναι δίσκεκτο αν διαιρείται με το 4 αλλά όχι με το 100 ή διαιρείται με το 400.](https://codecheck.io/files/2310081937bqfuui523g03bw7eohm2gvj6v)
4. [Να γραφτεί ένα πρόγραμμα που να επιστρέφει τα ρέστα μετά την αγορά ενός αντικειμένου](https://codecheck.io/files/2311051528d2rt9o8ut17pyyd783crkyl6i). Μια τυπική εκτύπωση του προγράμματος είναι η παρακάτω:
```
