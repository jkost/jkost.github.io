...
Ας λύσουμε την άσκηση 1. Αν θυμάστε από το σχολείο για να επιλύσουμε μια δευτεροβάθμια εξίσωση χρειάζεται πρώτα να υπολογίσουμε την διακρίνουσα: ```Δ=β&sup;2-4αγ```. 

* Αν Δ>0 τότε υπάρχουν δυο πραγματικές λύσεις: ```x&sub;1=(-β+&#8730;Δ)/2α``` και ```x&sub;2=(-β-&#8730;Δ)/2α```.
