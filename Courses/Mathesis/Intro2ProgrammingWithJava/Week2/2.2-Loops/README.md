...
12. [Υπολογίστε πότε πέφτει το ορθόδοξο Πάσχα](https://codecheck.io/files/24062421056gt31apgn27yirebwwabi8s1c) με βάση τον [αλγόριθμο του Gauss](https://www.ma8imatikos.gr/%CE%B1%CE%BB%CE%B3%CF%8C%CF%81%CE%B9%CE%B8%CE%BC%CE%BF%CF%82-gauss-%CE%B3%CE%B9%CE%B1-%CF%84%CE%BF%CE%BD-%CF%85%CF%80%CE%BF%CE%BB%CE%BF%CE%B3%CE%B9%CF%83%CE%BC%CF%8C-%CE%B7%CE%BC%CE%B5%CF%81%CE%BF/). Tο Ορθόδοξο Πάσχα πέφτει στις (```d+e+4```) Απριλίου (αν η ημερομηνία αυτή είναι μεγαλύτερη από 30, τότε πέϕτει μέσα στον Μάιο), όπου ```d = (19 · a + 15) mod 30, e = (2 · b + 4 · c + 6 · d + 6) mod 7, a = year mod 19, b = year mod 4 και c = year mod 7```.
