...
7. Μια τριπλέτα του Πυθαγόρα είναι ένα σύνολο φυσικών αριθμών, ```a < b < c```, για τους οποίους ισχύει: a<sup>2</sup> + b<sup>2</sup> = c<sup>2</sup>. Π.χ. 3<sup>2</sup> + 4<sup>2</sup> = 3^2 + 4^2 = 9 + 16 = 25 = 5<sup>2</sup> . Υπάρχει ακριβώς μια Πυθαγόρεια τριπλέτα για την οποία ισχύει: ```a + b + c = 1000```. Βρείτε αυτήν την τριπλέτα ```a, b, c```. 
