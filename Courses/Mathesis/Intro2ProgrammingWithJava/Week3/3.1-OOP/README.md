...
Μπορείτε να εξασκηθείτε μόνοι σας στα records εδώ [![Java Almanac](../../../assets/javaalmanac.svg)](sandbox/records.html).
...
Μπορείτε να εξασκηθείτε μόνοι σας στην κλάση ```Point``` εδώ [![Java Almanac](../../../assets/javaalmanac.svg)](sandbox/point.html).
...
Μπορείτε να εξασκηθείτε μόνοι σας στην κλάση ```Car``` εδώ [![Java Almanac](../../../assets/javaalmanac.svg)](sandbox/car.html).
