...
Μπορείτε να εξασκηθείτε μόνοι σας στα records εδώ <a href="sandbox/records.html"><img src="../../../assets/javaalmanac.svg" alt="javaalmanac.io" style="width:10%; height:auto;"></a>.
...
Μπορείτε να εξασκηθείτε μόνοι σας στην κλάση ```Point``` εδώ <a href="sandbox/point.html"><img src="../../../assets/javaalmanac.svg" alt="javaalmanac.io" style="width:10%; height:auto;"></a>.
...
Μπορείτε να εξασκηθείτε μόνοι σας στην κλάση ```Car``` εδώ <a href="sandbox/car.html"><img src="../../../assets/javaalmanac.svg" alt="javaalmanac.io" style="width:10%; height:auto;"></a>.
...
b1 ==> ClassRoom{name=Β1, size=30, numOfStudents=0}
```
Εξασκηθείτε εδώ <a href="sandbox/classroom.html"><img src="../../../assets/javaalmanac.svg" alt="javaalmanac.io" style="width:10%; height:auto;"></a>
