...
Σε αυτό το προαιρετικό μάθημα θα αναφερθούμε μόνο τα διαγράμματα με τα οποία θα ασχοληθούμε σε αυτό το εισαγωγικό μάθημα της Java και τα οποία δηλώνονται παρακάτω με το √.
...
**Εικόνα 3.3.7** _Παράδειγμα διαγράμματος αντικειμένων_
...
**Εικόνα 3.3.8** _Παράδειγμα διαγράμματος βιβλιοθηκών_
