...
3) Πώς θα μπορούσατε να 'χακάρετε' την κλάση ```Stack```; Π.χ. μπορείτε να δημιουργήσετε μια στοίβα που να γεμίσει τη μνήμη του υπολογιστή (να μη δουλέψει δηλ. η ```isFull()```); Αφού βρείτε το bug, πώς μπορείτε να το διορθώσετε;
