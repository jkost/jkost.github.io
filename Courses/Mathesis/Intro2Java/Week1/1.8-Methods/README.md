...
7. Να γραφτεί μια μέθοδος ```boolean anagram(String s1, String s2)``` που θα δέχεται δυο αλφαριθμητικά και να επιστρέφει ```true``` αν η μία είναι αναγραμματισμός της άλλης. Π.χ. η λέξη ```φάρος``` είναι αναγραμματισμός της λέξης ```αφρός```.
