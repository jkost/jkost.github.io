...
**Εικόνα 5** _Χωρίς διαχείριση εξαιρέσεων_
...
* Αποφεύγετε να διαχειρίζεστε (catch) ```NullPointerException```s. Όπως θα δούμε στη συνέχεια, οι ```NullPointerException```s ανήκουν στην κατηγορία των μη ελεγχόμενων εξαιρέσεων. Συνήθως δηλώνει ότι υπάρχει κάποιο λάθος στο πρόγραμμά μας, οπότε το καλύτερο είναι να διοθρώσετε αυτό το πρόβλημα.
