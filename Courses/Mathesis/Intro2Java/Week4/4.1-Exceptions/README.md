...
Συνίσταται να διαχειρίζεστε _πάντα_ τις _ελεγχόμενες (checked)_ εξαιρέσεις (βλ. και τις συμβουλές παρακάτω). Ας δούμε ένα παράδειγμα:
