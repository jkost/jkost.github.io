...
**Εικόνα 2.2.1** _4+1 όψεις της UML_
...
**Εικόνα 2.2.2** _Συμβολολογία διαγράμματος σεναρίου_
...
**Εικόνα 2.2.3** _Παράδειγμα διαγράμματος σεναρίου_
...
Μια κλάση αναπαριστά μια ομάδα ίδιων πραγμάτων που έχουν κοινή κατάσταση (state) και συμπεριφορά (behavior). Μια κλάση αναπαρίσταται στη UML ως ένα ορθογώνιο παραλληλογράμμο (βλ. Εικόνα 2.2.4) που αποτελείται από τρία μέρη: το _όνομα_ της κλάσης, τα _γνωρίσματά_ της και τις _μεθόδους_ της. 

![](assets/Fig4.png)

**Εικόνα 2.2.4** _Συμβολολογία διαγράμματος κλάσεων_
...
**Εικόνα 2.2.5** _Παράδειγμα διαγράμματος κλάσης στη UML_
...
**Εικόνα 2.2.6** _Παράδειγμα διαγράμματος αντικειμένων_
...
**Εικόνα 2.2.7** _Παράδειγμα διαγράμματος βιβλιοθηκών_
...
**Εικόνα 2.2.8** _Συμβολολογία διαγράμματος συνιστωσών/εξαρτημάτων_
...
**Εικόνα 2.2.9** _Παράδειγμα διαγράμματος συνιστωσών/εξαρτημάτων_
...
**Εικόνα 2.2.10** _Συμβολολογία διαγράμματος σύνθετης δομής_
...
**Εικόνα 2.2.11** _Παράδειγμα διαγράμματος σύνθετης δομής_
...
**Εικόνα 2.2.12** _Συμβολολογία διαγράμματος εγκατάστασης_

![](assets/Fig13.png)

**Εικόνα 2.2.13** _Παράδειγμα διαγράμματος εγκατάστασης_
...
**Εικόνα 2.2.14** _Συμβολολογία διαγράμματος ακολουθίας_
...
**Εικόνα 2.2.15** _Παράδειγμα διαγράμματος ακολουθίας_
...
**Εικόνα 2.2.16** _Παράδειγμα διαγράμματος επικοινωνίας_
...
**Εικόνα 2.2.17** _Συμβολολογία διαγραμμάτων μετάβασης κατάστασης_
...
Η Εικόνα 2.2.18 δείχνει ένα παράδειγμα διαγράμματος μετάβασης κατάστασης. Η κατάσταση μεταβαίνει από ```OK``` σε ```Overdrawn``` αν ικανοποιείται η συνθήκη φύλακας ```[balance < amount]```. Οι μεταβάσεις που ξεκινούν και τερματίζονται στην ίδια κατάσταση καλούνται _αυτο-μεταβάσεις (self-transitions)_.

![](assets/Fig18.png)

**Εικόνα 2.2.18** _Παράδειγμα διαγράμματος μετάβασης κατάστασης_
...
Μια δραστηριότητα είναι μια ενέργεια που χρειάζεται κάποιο χρόνο για να ολοκληρωθεί και απεικονίζεται ως _κατάσταση ενέργειας (action state)_ (βλ. Εικόνα 2.2.19). Οι διακλαδώσεις (branches) και οι συγχωνεύσεις (merges) δηλώνουν συνθήκες και απεικονίζονται με διαμάντι (βλ. Εικόνα 2.2.19). Μια διακλάδωση έχει μια μόνο εισερχόμενη μετάβαση και πολλές,
...
**Εικόνα 2.2.19** _Συμβολολογία διαγράμματος δραστηριότητας_
...
**Εικόνα 2.2.20** _Παράδειγμα διαγράμματος δραστηριότητας_
...
**Εικόνα 2.2.21** _Παράδειγμα διαγράμματος αλληλεπίδρασης_
...
**Εικόνα 2.2.22** _Παράδειγμα διαγράμματος χρονισμού_ 
