...
Μπορούμε να δημιουργήσουμε και ανώνυμες εσωτερικές κλάσεις, αλλά θα τις περιγράψουμε στο επόμενο μάθημα.
