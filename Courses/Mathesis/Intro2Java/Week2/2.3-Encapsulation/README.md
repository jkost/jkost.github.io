...
Πέρα από τα αρθρώματα ```java``` υπάρχουν και αρθρώματα ```jdk``` και ```javafx```. Συνολικά το JDK έχει τμηματοποιηθεί σε 78 αρθρώματα (στην έκδοση 16 έχουν μειωθεί στα 67):
```java
java.activation
java.base
java.compiler
