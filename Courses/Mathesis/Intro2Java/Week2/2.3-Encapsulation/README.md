...
**Εικόνα 1** _Περιγραφέας αρθρώματος (module descriptor)_
...
**Εικόνα 2** _Το JDK 9 τμηματοποιημένο σε αρθρώματα_
...
**Εικόνα 3** _Δημιουργία αρθρώματος με το NetBeans_

![](assets/Fig4.png)

**Εικόνα 4** _Γραφική αναπαράσταση εξαρτήσεων από το NetBeans_
...
**Εικόνα 5** _Απαγορεύονται οι κυκλικές εξαρτήσεις μεταξύ αρθρωμάτων_
