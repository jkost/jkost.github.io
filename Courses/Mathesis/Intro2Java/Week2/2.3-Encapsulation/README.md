...
Μια _εσωτερική (inner) κλάση_ είναι μια μη στατική κλάση που δηλώνεται μέσα σε μια άλλη κλάση. Αν η εσωτερική κλάση δηλωθεί ως static, τότε θεωρείται _εμφωλιασμένη (nested) κλάση_.


public class 

Δεν μπορούμε να δηλώσουμε στατικές μεταβλητές ή μεθόδους σε μια εσωτερική κλάση εκτός κι αν πρόκεται για μια σταθερά πρωτογενούς τύπου ή τύπου συμβολοσειράς.
