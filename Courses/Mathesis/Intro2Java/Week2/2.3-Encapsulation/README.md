...
Μπορούμε όμως να δηλώσουμε και ανώνυμες εσωτερικές κλάσεις, π.χ.
...
```
Η μέθοδος ```addActionListener()``` της κλάσης ```JButton``` δέχεται ως όρισμα ένα αντικείμενο τύπου ```ActionListener```. Αντί να δημιουργήσουμε ένα νέο αντικείμενο αυτής της διεπαφής και να το περάσουμε ως όρισμα στην ```addActionListener()```, δημιουργήσαμε μια ανώνυμη χχχχχχχχχ
...
//...
	...
	public Car(String m, int s, Engine engine) {
	//...	
	}

    public static void main(String[] args) {
        Engine engine = new Engine(1984, 6000, 170);
...
```
Η ```Engine``` πλέον έχει πρόσβαση στα στατικά γνωρίσματα και μεθόδους της ```Car```. Στην περίπτωση αυτή, η ```Engine``` μπορεί να "επιβιώσει" και χωρίς την ```Class```, δηλ. η σχέση μεταξύ τους είναι απλής _συσσωμάτωσης (aggregation)_.
